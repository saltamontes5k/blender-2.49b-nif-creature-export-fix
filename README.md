...
Bin\Blender\pyffi\formats\nif\__init__.py: 3. Line 6835 — Added the new _pre_reduce_vertex_weights() method to the NiGeometry class.
...
Backup original export_nif.py, __init__.py, and nif_common.py
